...
<html lang="en">
  <head>
	<!--- ballina_start --->
	<link href="../../Ndryshimi/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
	<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
	<script src="js/jquery.min.js"></script>
	<!-- Custom Theme files -->
	<!--theme-style-->
	<link href="../../Ndryshimi/css/style.css" rel="stylesheet" type="text/css" media="all" />	
	<!--//theme-style-->
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-clone"></i>Contact Us <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="webs/contact_us.php">View</a></li>
