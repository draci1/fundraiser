                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="index2.html">Modify</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Categories <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form.html">View</a></li>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-windows"></i> Users <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="projects.html">Modify</a></li>
                    </ul>
                  </li>
...
<div class="webpage-content">
	<?php include("../../../shared/inclusive/categories.php");?>
		</div>
	</div>
		<!--- drilona_end --->
		</div>
