...
<body>
    <div class="container">
        <img src="../../../shared/image/fundraiser.jpg" />
        <section>
            <div class="double-border">
                ...
                <input placeholder="E-mail" style="margin-bottom:5%;width:90%;border-radius:10px;border:none;" name="email" required><br /><br />
                <input type="password" placeholder="Password" style="margin-bottom:7.5%;width:90%;border-radius:10px;border:none;" name="password" required/><br />
